/*
To * Copyright (C) 2006 The Android Open Source Project
 *
	 ...
	 */
	 ...
	 public boolean onTouchEvent(MotionEvent ev) {
		 ...
		 case MotionEvent.ACTION_DOWN:
			 ...
			 mStart.x = (int)ev.getRawX() - getScrollX();
			 mStart.y = (int)ev.getRawY() - getScrollY();
		 ...
		 case MotionEvent.ACTION_UP:
			 ...
			 if((initialXVelocity > mMinimumVelocity && initialYVelocity > mMinimumVelocity))
	 ...
	 protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
		 ...
		 try {
			 FocusFinder.getInstance().findNextFocus(this, null, direction).setTag("S1");
	 ...
	 protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		 ...
		 if(oldw == 0 ) {
			 Log.d("RDP2", "First resize "+getChildAt(0).getClass().getName());
